...
const App = props => {
  ...
  return (
    <div className="App">
      <div className="PlaylistCollection small-4 columns">
        <PlaylistCollection selectedPlaylistId = {data.selectedPlaylistId} data={data.playlists}/>
      </div>
      <div className="SongList small-4 columns">
        <SongList data={selectedPlaylistSongs} selectedSongId ={data.selectedSongId} handleButtonClick={handleButtonClick} />
      </div>
      <div className="SelectedSong small-4 columns">
